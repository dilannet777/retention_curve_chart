...
function retention_chart_metrix($chartData,$options=[]){
    ...
    foreach ($chartData as $dateKey=>$steps){
        ...
        $weekMetrix['pointBackgroundColor']=$options['point_background_color']?$options['point_background_color']:'white';
        $weekMetrix['borderWidth'] = $options['point_background_color']?$options['border_width']:1;
